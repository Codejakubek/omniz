...
#ifndef SD_CONFIGURATION_JSON_PARSER_H
#define SD_CONFIGURATION_JSON_PARSER_H

#include <SigmaDev/Misc/Class.h>

class SD_Application;
////////////////////////////////////////
/** TODO: SD_JsonParser_Implementation */
class SD_JsonParser : public SD_Class {
public:
    SD_DECLARE_CLASS_H()

    SD_JsonParser() = delete;
    SD_JsonParser(SD_Application& application_reference);
